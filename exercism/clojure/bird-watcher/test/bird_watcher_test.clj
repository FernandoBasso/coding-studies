...
(deftest ^{:task 8} odd-week-not-matching-test-with-alternate-not-0-1
  (testing "Odd week with non 0 and 1 but alternating anyway"
    (is (= false (bird-watcher/odd-week? [2 1 2 1 2 1 2])))))
