...
Always keep in mind the order the decorators run:

    @f('foo')
    @g('bar)
    class Qux {}

Here, g decorator runs first, nog f.

Alays make sure to understand the parameters each decorator takes.
Class decortors' first param is the constructor.
*/
