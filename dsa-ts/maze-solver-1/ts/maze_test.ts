...
import { type Point, solve } from "./maze.ts";
...
Deno.test("maze solve()", async (t) => {
  await t.step("should create the correct solution path", () => {
    ...
    assertEquals(drawPath(maze, actual), drawPath(maze, expected));
  });
});
